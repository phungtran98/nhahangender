        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Food-fair-toggle">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#great-place-to-enjoy">Đồ uống</a></li>
                    <li><a href="#breakfast">Điểm tâm</a></li>
                    <li><a href="#featured-dish">Thực đơn</a></li>
                    <li><a href="#reserve">Đặt bàn</a></li>
    ...
    <div class="container-fluid">
        <div class="navbar-2">
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="{{URL::to('/show-cart')}}"><i class="fa fa-shopping-cart"></i> Giỏ hàng</a>
                </li>
                <?php
